...
if(isset($_GET['status']))
{
    ...
    if ($status=='category')
    {
        ...
        $product_result=$obj_product->select_publiched_product_by_category_id($category_id);
    }
    elseif ($status=='manufacturer')
    {
        $manufacturer_id=$_GET['manufacturer_id'];
        $product_result=$obj_product->select_publiched_product_by_manufacturer_id($manufacturer_id);
    ...
    $product_result=$obj_product->select_publiched_product();
}
...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
    ...
    <head>
        ...
        <!--stylesheet include-->
        <link rel="stylesheet" type="text/css" media="all" href="asset/front_end/css/colorpicker.css">
        ...
        <script src="asset/front_end/js/country.js" type="text/javascript"></script>
        <script src="asset/front_end/js/jsval.js" type="text/javascript"></script>
    </head>
    <body>
        ...
        <div class="wide_layout relative w_xs_auto">
                ...
                <section class="h_top_part">
                    <div class="container">
                        <div class="row clearfix">
                            ...
                            {
                            ?>
                                 <p class="f_size_small">Welcome visitor can you	<a href="cart.php" >Log In</a> or <a href="cart.php">Create an Account</a> </p>
                            <?php }else { ?>
                           
                                <p class="f_size_small">Welcome <?php echo $_SESSION['customer_name']?> can you <a href="?logout=logout" >Logout</a> </p>
                            <?php } ?>
                             </div>
                            ...
                            <nav class="col-lg-4 col-md-4 col-sm-6 t_align_c t_xs_align_c">
                                <ul class="d_inline_b horizontal_list clearfix f_size_small users_nav">
                                    ...
                                    <li><a href="cart.php" class="default_t_color">Cart</a></li>
                                </ul>
                            </nav>
                            <div class="col-lg-4 col-md-4 col-sm-3 t_align_r t_xs_align_c">
                                <ul class="horizontal_list clearfix d_inline_b t_align_l f_size_small site_settings type_2">
                                    <li class="container3d relative">
                                        <a role="button" href="#" class="color_dark" id="lang_button"><img class="d_inline_middle m_right_10" src="asset/front_end/images/flag_en.jpg" alt="">English</a>
                                        <ul class="dropdown_list type_2 top_arrow color_light">
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="asset/front_end/images/flag_en.jpg" alt="">English</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="asset/front_end/images/flag_fr.jpg" alt="">French</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="asset/front_end/images/flag_g.jpg" alt="">German</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="asset/front_end/images/flag_i.jpg" alt="">Italian</a></li>
                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="asset/front_end/images/flag_s.jpg" alt="">Spanish</a></li>
                                        </ul>
                                    </li>
                            ...
                            <ul class="horizontal_list main_menu clearfix">
                                ...
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="category_grid.html" class="tr_delay_hover color_light tt_uppercase"><b>Shop</b></a>
                                    ...
                                    <div class="sub_menu_wrap top_arrow d_xs_none tr_all_hover clearfix r_corners w_xs_auto">
                                        ...
                                        <img src="asset/front_end/images/woman_image_1.jpg" class="d_sm_none f_right m_bottom_10" alt="">
                                    </div>
                                </li>
                                ...
                                <div class="shopping_cart top_arrow tr_all_hover r_corners">
                                    ...
                                    <ul class="products_list">
                                        <li>
                                            <div class="clearfix">
                                                <!--product image-->
                                                <img class="f_left m_right_10" src="asset/front_end/images/shopping_c_img_1.jpg" alt="">
                                                <!--product description-->
                                        ...
                                        <li>
                                            <div class="clearfix">
                                                <!--product image-->
                                                <img class="f_left m_right_10" src="asset/front_end/images/shopping_c_img_2.jpg" alt="">
                                                <!--product description-->
                                                <div class="f_left product_description">
                                                    <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                    <span class="f_size_medium">Product Code PS34</span>
                                        ...
                                        <li>
                                            <div class="clearfix">
                                                <!--product image-->
                                                <img class="f_left m_right_10" src="asset/front_end/images/shopping_c_img_3.jpg" alt="">
                                                <!--product description-->
                                                <div class="f_left product_description">
                                                    <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                    <span class="f_size_medium">Product Code PS34</span>
            ...
            <div class="page_content_offset">
                ...
                if(isset($page))
                {
                  if($page=='product_details_page.php')
                  {
                      include './pages/product_details_page.php';
                  }
                   else if($page=='cart_page.php')
                  {
                      include './pages/cart_page.php';
                  }
                   else if($page=='shipping_form.php')
                  {
                      include './pages/shipping_form.php';
                  }
                      else if($page=='payment_form.php')
                  {
                      include './pages/payment_form.php';
                  }
                      else if($page=='complete.php')
                  {
                    ...
                    <div class="custom_scrollbar">
                        ...
                        <div class="f_left half_column">
                            <div class="relative d_inline_b m_bottom_10 qv_preview">
                                ...
                                <img src="asset/front_end/images/quick_view_img_1.jpg" class="tr_all_hover" alt="">
                            </div>
                            <!--carousel-->
                            <div class="relative qv_carousel_wrap m_bottom_20">
                                ...
                                <ul class="qv_carousel d_inline_middle">
                                    <li data-src="asset/front_end/images/quick_view_img_1.jpg"><img src="asset/front_end/images/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="asset/front_end/images/quick_view_img_2.jpg"><img src="asset/front_end/images/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="asset/front_end/images/quick_view_img_3.jpg"><img src="asset/front_end/images/quick_view_img_6.jpg" alt=""></li>
                                    <li data-src="asset/front_end/images/quick_view_img_1.jpg"><img src="asset/front_end/images/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="asset/front_end/images/quick_view_img_2.jpg"><img src="asset/front_end/images/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="asset/front_end/images/quick_view_img_3.jpg"><img src="asset/front_end/images/quick_view_img_6.jpg" alt=""></li>
                                </ul>
        ...
        <script src="asset/front_end/js/styleswitcher.js"></script>
        <script src="asset/front_end/js/colorpicker.js"></script>
        ...
        <script src="asset/front_end/js/jquery-migrate-1.2.1.min.js"></script>
        <script src="asset/front_end/js/elevatezoom.min.js"></script>
        <script src="asset/front_end/js/jquery.fancybox-1.3.4.js"></script>
    </body>
