                    ...
                    <section class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_sm_bottom_35">
                            <a href="#" class="d_block banner animate_ftr wrapper r_corners relative m_xs_bottom_30">
                                <img src="asset/front_end/images/banner_img_1.png" alt="">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_sm_bottom_35">
                            <a href="#" class="d_block banner animate_ftr wrapper r_corners type_2 relative">
                                <img src="asset/front_end/images/banner_img_2.png" alt="">
                                <span class="banner_caption d_block vc_child t_align_c w_sm_auto">
                                    <span class="d_inline_middle">
                                ...
                                <div class="widget_content">
                                    ...
                                    <ul class="categories_list">
                                        ...
                                        while ($row = mysql_fetch_assoc($category_result)) {
                                            ...
                                            <li class="active">
                                                <a href="?status=category&category_id=<?php echo $row['category_id']?>" class="f_size_large scheme_color d_block relative">
                            ...
                            <section class="products_container a_type_2 category_grid clearfix m_bottom_25">
                                ...
                                <div class="product_item hit w_xs_full">
                                    <figure class="r_corners photoframe animate_ftb type_2 t_align_c tr_all_hover shadow relative">
                                        <!--product preview-->
                                        <a href="product_details.php?product_id=<?php echo $row['product_id']?>" class="d_block relative pp_wrap m_bottom_15">
                                            <!--hot product-->
...
<!--                                            <span role="button" data-popup="#quick_view_product" class="button_type_5 box_s_none color_light r_corners tr_all_hover d_xs_none">Quick View</span>-->
                                        ...
                                        <figcaption>
                                            ...
                                            <p class="scheme_color f_size_large m_bottom_15">BDT <?php echo $row['product_price']?></p>
                                            <form method="post" action="">
                                                <input type="hidden" name="product_id" value="<?php echo $row['product_id']?>" >
                                                <input type="hidden"  name="qty" value="1">
                                                <button type="submit" name="cart" class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15">Add to Cart</button>
                                           </form>
                                            <div class="clearfix m_bottom_5">
                            ...
                            <div class="nc_carousel m_bottom_30 m_sm_bottom_20">
                                ...
                                <figure class="r_corners photoframe animate_ftb long type_2 t_align_c shadow relative tr_all_hover">
                                    ...
                                    <a href="#" class="d_block relative pp_wrap m_bottom_15">
                                        <!--sale product-->
                                        <span class="hot_stripe type_2"><img src="asset/front_end/images/sale_product_type_2.png" alt=""></span>
                            ...
                            <div class="product_brands with_sidebar m_sm_bottom_35">
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="?status=manufacturer&manufacturer_id=<?php echo $row['manufacturer_id']?>" class="d_block t_align_c animate_fade"><img src="asset/front_end/images/brand_logo.jpg" alt=""><?php echo $row['manufacturer_name']?></a>
                                    <?php } ?>
                            </div>
                        </section>
                    </div>
