...
$query_result=$obj_product->select_product_by_id($product_id);
$row=mysql_fetch_assoc($query_result);
$manufacturer_id=$row['manufacturer_id'];
$manufacturer_result=$obj_product->select_publiched_manufacturer_id($manufacturer_id);
$manufacturer=mysql_fetch_assoc($manufacturer_result);
    ...
    <div class="clearfix m_bottom_30 t_xs_align_c">
        <div class="photoframe type_2 shadow r_corners f_left f_sm_none d_xs_inline_b product_single_preview relative m_right_30 m_bottom_5 m_sm_bottom_20 m_xs_right_0 w_mxs_full">
            ...
            <div class="relative d_inline_b m_bottom_10 qv_preview d_xs_block">
                <img id="zoom_image" src="admin/<?php echo $row['product_image']?>" height="400" data-zoom-image="admin/<?php echo $row['product_image']?>" class="tr_all_hover" alt="">
                <a href="asset/front_end/images/preview_zoom_1.jpg" class="d_block button_type_5 r_corners tr_all_hover box_s_none color_light p_hr_0">
...
<!--            <div class="relative qv_carousel_wrap">
                ...
                <ul class="qv_carousel_single d_inline_middle">
                    <a href="#" data-image="asset/front_end/images/quick_view_img_7.jpg" data-zoom-image="asset/front_end/images/preview_zoom_1.jpg"><img src="asset/front_end/images/quick_view_img_10.jpg" alt=""></a>
                    <a href="#" data-image="asset/front_end/images/quick_view_img_8.jpg" data-zoom-image="asset/front_end/images/preview_zoom_2.jpg"><img src="asset/front_end/images/quick_view_img_11.jpg" alt=""></a>
                    <a href="#" data-image="asset/front_end/images/quick_view_img_9.jpg" data-zoom-image="asset/front_end/images/preview_zoom_3.jpg"><img src="asset/front_end/images/quick_view_img_12.jpg" alt=""></a>
                    <a href="#" data-image="asset/front_end/images/quick_view_img_16.jpg" data-zoom-image="asset/front_end/images/preview_zoom_4.jpg"><img src="asset/front_end/images/quick_view_img_13.jpg" alt=""></a>
                    <a href="#" data-image="asset/front_end/images/quick_view_img_17.jpg" data-zoom-image="asset/front_end/images/preview_zoom_5.jpg"><img src="asset/front_end/images/quick_view_img_14.jpg" alt=""></a>
                    <a href="#" data-image="asset/front_end/images/quick_view_img_18.jpg" data-zoom-image="asset/front_end/images/preview_zoom_6.jpg"><img src="asset/front_end/images/quick_view_img_15.jpg" alt=""></a>
                </ul>
        ...
        <div class="p_top_10 t_xs_align_l">
            ...
            <table class="description_table m_bottom_10">
                <tr>
                    <td>Manufacturer:</td>
                    <td><a href="#" class="color_dark"><?php echo $manufacturer['manufacturer_name']?></a></td>
                </tr>
                <tr>
                    <td>Availability:</td>
...
<!--            <hr class="divider_type_3 m_bottom_10">
            ...
            <div class="m_bottom_15">
                <s class="v_align_b f_size_ex_large">$152.00</s><span class="v_align_b f_size_big m_left_5 scheme_color fw_medium">BDT <?php echo $row['product_price']?></span>
            </div>
...
<!--                <tr>
            ...
            <div class="d_ib_offset_0 m_bottom_20">
                <button type="submit" name="cart" class="button_type_12 r_corners bg_scheme_color color_light tr_delay_hover d_inline_b f_size_large">Add to Cart</button>
    ...
    <div class="related_projects product_full_width m_bottom_15">
        ...
        <figure class="r_corners photoframe shadow relative d_inline_b d_md_block d_xs_inline_b tr_all_hover">
            <!--product preview-->
            <a href="product_details.php?product_id=<?php echo $row['product_id']?>" class="d_block relative pp_wrap">
                <!--hot product-->
                <span class="hot_stripe type_2"><img src="asset/front_end/images/hot_product_type_2.png" alt=""></span>
                <img src="admin/<?php echo $row['product_image']?>" height="200" class="tr_all_hover" alt="">
<!--                <span data-popup="#quick_view_product" class="button_type_5 box_s_none color_light r_corners tr_all_hover d_xs_none">Quick View</span>-->
            ...
            <figcaption class="t_xs_align_l">
                <h5 class="m_bottom_10"><a href="#" class="color_dark ellipsis"><?php echo $row['product_name']?></a></h5>
                <div class="clearfix">
                    <p class="scheme_color f_left f_size_large m_bottom_15">BDT <?php echo $row['product_price']?></p>
                    <!--rating-->
