...
{
    $message=$obj_cart->save_customer_info($_POST);
}
if(isset($_POST['login']))
{
    $message=$obj_cart->check_customer_info($_POST);
}
?>
...
<div class="container">
    <div class="row clearfix">
        ...
        <section class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
            <h2 class="tt_uppercase color_dark m_bottom_25">Cart & Customer Information</h2>
            <!--cart table-->
            <table class="table_type_4 responsive_table full_width r_corners wraper shadow t_align_l t_xs_align_c m_bottom_30">
                ...
                <tr>
                    ...
                    <td colspan="1" class="v_align_m">
                        <p class="fw_medium f_size_large scheme_color m_xs_bottom_10">BDT 
                           <?php        $g_total= $total + $vat - $coupon;
                            ...
                            <ul>
                                <li class="clearfix m_bottom_15">
                                    <div class="half_column type_2 f_left">
                                        <label for="username" class="m_bottom_5 d_inline_b">Email Address</label>
                                        <input type="email" id="username" name="email_address" class="r_corners full_width m_bottom_5">
                        ...
                        <form action="" method="post" onsubmit="return validateStandard(this)">
                            <ul>
                                <li class="m_bottom_15">
                                    ...
                                    <input type="text" id="d_name" name="customer_name" required regexp="JSVAL_RX_ALPHA" err="Please Type Only Alphabet" class="r_corners full_width">
                                </li>
                                ...
                                <li class="m_bottom_15">
                                    <label for="u_email" class="d_inline_b m_bottom_5 required">Password</label>
                                    <input type="password" id="u_email" name="password" class="r_corners full_width">
                                </li>
                                <li class="m_bottom_15">
                                    <label for="u_pass" class="d_inline_b m_bottom_5 required">Confirm Password</label>
                                    <input type="password" id="u_pass" equals="password"  class="r_corners full_width">
                                </li>
                                <li class="m_bottom_15">
                                ...
                                <br>
                                <li><button name="registration" type="submit" class="button_type_4 r_corners bg_scheme_color color_light tr_all_hover">Registration</button></li>
                            </ul>
                        </form>
                    </div>
                </section>
