...
{
    $obj_cart->save_order_info($_POST);
}
?>
<div class="container">
    <div class="row clearfix">
        ...
        <section class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
            <h2 class="tt_uppercase color_dark m_bottom_25">Cart & Payment</h2>
            <!--cart table-->
            ...
            <div class="bs_inner_offsets bg_light_color_3 shadow r_corners m_bottom_45">
                ...
                <figure class="block_select clearfix relative">
                    <input type="radio" name="payment_type"  value="cash_on_delivery"class="d_none">
                    <img src="images/payment_logo.jpg" alt="" class="f_left m_right_20 f_mxs_none m_mxs_bottom_10">
                    <figcaption>
                  ...
                  <hr class="m_bottom_20">
                <button type="submit" name="payment" class="button_type_4 r_corners bg_scheme_color color_light tr_all_hover">Payment</button>
            </div>
</form>
        </section>
        <!--right column-->
